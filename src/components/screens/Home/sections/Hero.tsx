...
const HeroHomeSection = () => {
	return (
		<section className="flex flex-col gap-4 justify-center p-main-p-3 sm:p-main-p-1 lg:flex-row ">
			<div className="lg:text-align-initial font-normal flex flex-col items-center justify-center gap-8 text-center text-lg lg:w-1/2 lg:items-start lg:justify-start min-[1350px]:w-auto">
				<motion.h1
