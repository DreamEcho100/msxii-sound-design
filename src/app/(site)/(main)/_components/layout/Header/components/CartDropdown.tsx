...
import ProductPrice from "~/app/components/core/Shopify/ProductPrice";
import ShopifyProductPrice from "~/app/components/core/Shopify/ProductPrice";
import ProductQuantityControllers from "~/app/components/core/ProductQuantityControllers";
      ...
      {isCartDropdownOpen && (
        <motion.div
          ...
          className={cx(
            ...
            "max-w-screen-xl-2-sm max-h-[75vh] w-full overflow-x-hidden",
            "flex flex-col gap-8",
          )}
        >
          <header>
...
const CartDetails = () => {
  ...
  return (
    <div className="flex flex-col gap-2">
      <div className="bg-bg-primary-600/50 dark:bg-bg-primary-700 flex flex-wrap justify-between gap-4 p-4">
