    ...
    >
      <DialogPrimitive.Portal>
        ...
        <DialogPrimitive.Content
          className={cx(
            "max-w-screen-xl-sm bg-bg-primary-100 dark:bg-bg-primary-500 text-text-primary-400 fixed left-1/2 top-1/2 z-20 max-h-[85vh] w-[90vw] -translate-x-1/2 -translate-y-1/2 rounded-md p-[25px] shadow-[hsl(206_22%_7%_/_35%)_0px_10px_38px_-10px,_hsl(206_22%_7%_/_20%)_0px_10px_20px_-15px] focus:outline-none",
            "scale-0 transition-all duration-300",
            "data-[state=open]:scale-100",
          )}
        >
  ...
  return (
    <header className="flex flex-col gap-3">
      ...
      <DialogPrimitive.Title
        className="text-text-primary-500 text-h3 m-0 font-medium"
        {...titleProps}
      />
